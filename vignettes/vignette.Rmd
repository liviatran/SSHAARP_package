...
>PALM("DRB1*26F~28E~30Y", variantType="motif", filename=SSHAARP::solberg_dataset)
```
...
>PALM("DRB1*26F~28E~30Y", mask = T, color=FALSE, variantType="motif", filename=SSHAARP::solberg_dataset)
```
...
> PALM("DRB1*01:01", variantType="allele", filename=SSHAARP::solberg_dataset)
```
...
> PALM("DRB1*01:01", variantType="allele", color=F, filename=SSHAARP::solberg_dataset)
```
...
PALM("A*01:01~DRB1*01:01", variantType="haplotype", filename=SSHAARP::mock_haplotype_dataset, color = TRUE)
```
...
```
#greyscale haplotype heatmap plot with masking OFF with bundled mock haplotype dataset
PALM("A*01:01~DRB1*01:01", variantType="haplotype", filename=SSHAARP::mock_haplotype_dataset, color = FALSE)
```
